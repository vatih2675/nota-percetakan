          ...
          {dataNota.map((nt, index) => (
            <>
              ...
              <div
                ...
                onClick={closeNota}
              >
                <div className="relative w-[107.5mm] h-[148.5mm] flex flex-col justify-between sm:border border-gray-200 mx-auto p-5 bg-white sm:shadow-md">
                  ...
                  <img
                    src="images/logo.png"
                    alt="Logo UBMG"
                    className="absolute w-50 top-20 left-0 translate-1/2 bg-transparent z-0"
                  />
                  <table className="relative w-full text-xs bg-white/95 z-1">
                    <thead>
                      <tr className="bg-sky-500 text-white">
                        <th className="p-1 border border-gray-300 text-center w-[8%]">
                          NO
                        </th>
                    ...
                    <tbody>
                      {nt.data.map((dt, index) => (
                        <tr key={index} className="text-gray-600">
                          ...
                          <td className="p-1 border border-gray-300 text-start">
                            {dt.uraian}
                          </td>
                          <td className="p-1 border border-gray-300 text-center">
                            {angka(dt.jumlah)} {dt.satuan}
                          </td>
                          <td className="p-1 border border-gray-300 text-end">
                            {angka(dt.harga)}
                          </td>
                          <td className="p-1 border border-gray-300 text-end">
                      ...
                      {(() => {
                        ...
                        for (let i = index; i < 9; i++) {
                          trKosong.push(
                            <tr key={i}>
                              <th className="p-1 border border-gray-300 text-white">
                                .
                              </th>
                              <th className="p-1 border border-gray-300 text-white">
                                .
                    ...
                    <tfoot>
                      <tr className="text-sky-700">
                        ...
                        <th className="p-1 border border-gray-300 text-end">
                          {angka(nt.total)}
                        </th>
                      </tr>
                    </tfoot>
                  ...
                  <div className="flex justify-center items-center">
                    <div className="w-7/12 pe-0 text-xs text-sky-700">
                    ...
                    <div className="w-5/12 text-sm text-center text-sky-700">
