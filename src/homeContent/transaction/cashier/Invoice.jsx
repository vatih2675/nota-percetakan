    ...
    <div className="border border-gray-200 shadow-md rounded-xl p-4 cursor-default mb-10">
      <div className="flex justify-between items-center mb-3">
        ...
        <div className="flex justify-center items-center gap-2">
          ...
          {total > 0 ? (
            <i
              className="bi-floppy text-gray-400 hover:text-sky-700 cursor-pointer transition-all duration-300"
              onClick={saveNota}
            ></i>
          ) : (
            ""
      ...
      <table className="w-full text-sm rounded-lg overflow-hidden">
        ...
        <tbody>
          {dataKasir.map((ksr, index) => (
            <tr key={index}>
              ...
              <td className="p-1 border border-gray-200 text-start">
                {ksr.uraian}
              </td>
              <td className="p-1 border border-gray-200 text-center">
              ...
              <td className="p-1 border border-gray-200 text-end">
                ...
                <i
                  className="bi-x text-gray-500 hover:text-red-500 ms-1 cursor-pointer transition-all duration-300"
                  onClick={() => deleteKasir(index)}
                ></i>
              </td>
            </tr>
          ))}
        ...
        <tfoot>
          <tr className="text-sky-700 bg-sky-100">
            <th className="p-1 border border-gray-200 text-end" colSpan="5">
              TOTAL Rp. {angka(total)}
            </th>
          </tr>
        </tfoot>
      </table>
